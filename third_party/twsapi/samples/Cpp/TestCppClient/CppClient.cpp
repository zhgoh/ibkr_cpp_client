...
void CppClient::setConnectOptions(const std::string& connectOptions)
{
	m_pClient->setConnectOptions(connectOptions);
}

void CppClient::processMessages()
{
...
void CppClient::pnlSingleOperation()
{
	//! [reqpnlsingle]
...
void CppClient::tickDataOperation()
{
	//! [reqmarketdatatype]
...
void CppClient::tickOptionComputationOperation()
{
	/*** Requesting real time market data ***/
	std::this_thread::sleep_for(std::chrono::seconds(1));
...
void CppClient::delayedTickDataOperation()
{
...
void CppClient::marketDepthOperations()
{
...
void CppClient::historicalDataRequests()
{
...
void CppClient::optionsOperations()
{
	//! [reqsecdefoptparams]
...
void CppClient::contractOperations()
{
...
void CppClient::accountOperations()
{
...
void CppClient::orderOperations()
{
...
void CppClient::conditionSamples()
{
...
void CppClient::testAlgoSamples(){
	//! [algo_base_order]
...
void CppClient::financialAdvisorOrderSamples()
{
	//! [faorderoneaccount]
...
void CppClient::financialAdvisorOperations()
{
...
void CppClient::testDisplayGroups(){
	//! [querydisplaygroups]
...
void CppClient::reqMatchingSymbols()
{
...
void CppClient::reqMktDepthExchanges()
{
...
void CppClient::reqSmartComponents()
{
...
void CppClient::reqNewsProviders()
{
...
void CppClient::reqHistoricalNews(){
...
void CppClient::reqHeadTimestamp() {
	//! [reqHeadTimeStamp]
...
void CppClient::reqHistogramData() {
	//! [reqHistogramData]
...
void CppClient::rerouteCFDOperations()
{
    //! [reqmktdatacfd]
...
void CppClient::marketRuleOperations()
{
...
void CppClient::continuousFuturesOperations()
{
...
void CppClient::reqHistoricalTicks()
{
	//! [reqhistoricalticks]
...
void CppClient::reqTickByTickData()
{
...
void CppClient::wshCalendarOperations() {
	//! [reqmetadata]
...
//! [tickprice]
void CppClient::tickPrice(TickerId tickerId, TickType field, double price, const TickAttrib& attribs) {
...
void CppClient::tickOptionComputation(TickerId tickerId, TickType tickType, int tickAttrib, double impliedVol, double delta,
...
//! [openorder]
void CppClient::openOrder(OrderId orderId, const Contract& contract, const Order& order, const OrderState& orderState) {
...
void CppClient::printContractMsg(const Contract& contract) {
	printf("\tConId: %ld\n", contract.conId);
...
void CppClient::printContractDetailsMsg(const ContractDetails& contractDetails) {
...
void CppClient::printContractDetailsSecIdList(const TagValueListSPtr &secIdList) {
...
void CppClient::printBondContractDetailsMsg(const ContractDetails& contractDetails) {
...
//! [accountsummary]
void CppClient::accountSummary(int reqId, const std::string& account, const std::string& tag, const std::string& value, const std::string& currency) {
...
void CppClient::verifyAndAuthMessageAPI(const std::string& apiDatai, const std::string& xyzChallenge) {
